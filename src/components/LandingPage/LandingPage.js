                ...
                <div className="wrapper">
                    <div className="bg-white pt-12">
                        <div className="flex flex-col md:flex-row items-center slogan-text">
                            <div
                                className="text-gray-dark pt-16 pb-8  md:px-4 lg:px-12 xl:px-24 w-2/3">
                                <div className="px-4 md:px-12 rounded">
                                    <p className="text-2xl md:text-3xl pb-8">Decidehub nedir?</p>
                                    <p className="text-base lg:text-lg pb-4">Decidehub en az 3 kişi olmak kaydı ile
                                        beraber çalışmak isteyen her türlü grubun her türlü konuda oylama yapabilmesini
                                        mümkün kılar.
                                    </p>
                                    <p className="text-base lg:text-lg pb-8">Burada gruplar <span className="text-emphasis">demokratik</span> ve <span className="text-emphasis">kalıcı</span> kararlar alır.</p>
                                </div>
                            </div>
                            <img
                                src={VotingLogo}
                    ...
                    <div className="static-one text-white flex justify-center flex-col" id="about-us">
                        <InfoContainerRight
