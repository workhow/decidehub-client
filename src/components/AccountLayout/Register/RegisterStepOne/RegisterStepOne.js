  ...
  render() {
    return (
      <div className="h-full">
        <p className="text-2xl mb-20 mt-5 text-gray-dark bg-white">
          Hesap Oluştur
        </p>
        <img src={image} alt="manager" className="m-auto mb-10" />
        <p className="text-center text-sm mb-10 mx-5 text-gray-dark">
          Her Grubu yanlızca bir yönetici oluşturur. Diğer üyeleri davet eder
          takımı sizden başka birinin yaratmadığından emin olun.
        </p>
        <div>
