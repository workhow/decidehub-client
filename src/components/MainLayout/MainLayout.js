...
export default function MainLayout() {
    ...
    const [state,
        setState] = React.useState({right: false, modalType: ""});
        ...
        return <div className="pb-64">
            ...
            <div className="ml-24">
                ...
                <div className="m-auto w-2/3 mt-16 text-sm">
                    ...
                    <div className="flex flex-row w-full bg-white border border-gray-light py-1 h-32 mt-8" onClick={toggleDrawer('authpollmodal', 'right', true)}>
                ...
                <div className="flex flex-row m-auto w-2/3 mt-8 text-sm">
                    <Link to="/policy" className="flex flex-col bg-white border border-gray-light w-1/2 h-64 mr-8">
                        <img src={InfoLogo} alt="question mark" className="ml-auto mr-5 mt-5"/>
                        <div className="w-3/5">
                    ...
                    <div className="flex flex-col justify-between w-1/2 h-64">
                        <div className="flex flex-row bg-white border border-gray-light py-1" onClick={toggleDrawer('sharepollmodal', 'right', true)}>
                        ...
                        <div className="flex flex-row bg-white border border-gray-light py-1" onClick={toggleDrawer('managerpollmodal', 'right', true)}>
                            <div className="pl-8 pb-5 w-1/5">
                ...
                <PollCard logo={AuthorithyLogoOne} pollName="2. Yetki Dağılımı Oylaması" pollEndDate="23 Tem 2018" statusText="Başlıyor.. " statusColor="blue"/>
                <PollCard logo={PuzzleLogo} pollName="2. Yetki Dağılımı Oylaması" pollEndDate="23 Tem 2018" statusText="Tamamlandı " statusColor="red"/>
            </div>
            
            <DrawerModal type={state.modalType} right={state.right} toggleDrawer={toggleDrawer}/>
        </div>
