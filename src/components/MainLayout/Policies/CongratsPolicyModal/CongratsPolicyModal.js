...
class CongratsPolicyModal extends Component {
    render() {
        return (
            <div className="flex flex-col pr-3 mt-8">
                <p className="text-2xl text-gray-dark w-1/2 align-left pl-2">Tebrikler yönetmelik değişikliği önerdin!</p>
                ...
                <div className="flex flex-col self-center w-1/2 mt-24">
                    <Button text="Devam Et" onClick={this.props.toggleDrawer('policyvotemodal', 'right', true)}/>
                </div>
            </div>
        )
    }
...
export default CongratsPolicyModal;