...
class CurrentPollsLayout extends React.Component {
    constructor(props) {
        ...
        this.handleNotificationClick = this
            ...
            .bind(this);
        this.handleNotificationClose = this
    ...
    vote(pollId) {
        return event => {
            ...
            const poll = this
                .state
                .polls
                .filter(poll => poll.pollId === pollId)[0];
            this.setState({
                ...this.state,
                votingPoll: poll
            }, () => {
                if (poll.listType === "userVoted") 
                    return;
                ...
                if (poll) {
                    return this.toggleDrawer(drawerForPollType(poll.type), "right", true)(event);
                }
            });
        };
    }
