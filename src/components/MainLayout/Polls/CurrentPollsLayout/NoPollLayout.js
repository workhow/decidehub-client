      ...
      <div className="main-layout">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center">
          <div className="w-1/2 sm:w-3/5 text-center sm:text-left mt-12 md:mt-16 lg:mt-20">
            <p className="text-gray-dark text-2xl mb-4 font-light">
              Henüz Başlamış bir oylama yok. İstersen yeni bir oylama
              başlatabilirsin!
            </p>
            <p className="text-gray-text text-sm mb-4 lg:mb-12">
              Ya da anasayfaya dönmelisin
            </p>
          </div>
