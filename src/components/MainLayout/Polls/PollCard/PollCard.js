        ...
        return (
            ...
            <div className="flex flex-row justify-between w-full py-2">
                <div className="flex flex-row w-1/2">
                    ...
                    <p className="p-5 text-gray-dark text-base">{this.props.pollName}</p>
                </div>
                <div className="flex flex-row w-1/3 justify-between ml-8">
                    <div className="flex flex-col justify-center">
                        <p className="text-gray-dark text-base">{this.props.pollEndDate}</p>
                        <SubHeader text="Sonlanma Tarihi"/>
                    </div>
                    <div className="flex h-full items-center ml-2">
                        <StatusIndicator text={this.props.statusText} color={this.props.statusColor}/>
                    </div>
